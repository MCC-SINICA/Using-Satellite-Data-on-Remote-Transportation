...
h28v6_14 = (np.load('h28v06_14_train.npy'))
...
test_data14 = pred_generat(h28v5_14,h28v6_14,h29v5_14,h29v6_14,
                        h31v6_14,pm_train_14,
...
predictions_edit = intermediate_layer_model.predict_generator(test_data14,steps = sample_per_valid, verbose=1,workers=0)



print(predictions_edit.shape)
np.save('middlelayer_foryear14_4hr_4tile.npy',predictions_edit)
